...
public class PayDemoActivity extends FragmentActivity {
     ...
     * 支付宝支付业务：入参app_id
     */
    public static final String APPID = "2017061407489558";

    /**
     * 支付宝账户登录授权业务：入参pid值
     */
    public static final String PID = "2088421590687653";
    /**
     * 支付宝账户登录授权业务：入参target_id值
     */
    public static final String TARGET_ID = "2089875617@qq.com";
    ...
    public void payV2(View v) {
        ...
        Log.d(TAG, "payV2() called with: orderInfo = [" + orderInfo + "]");
